...
[MAC_BASE] = LAYOUT_ansi_68(
     ...
     KC_CAPS,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     RALT(KC_N),  KC_QUOT,           KC_ENT,  KC_PGUP,
     KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,     KC_RSFT, KC_UP,             KC_PGDN,
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                       KC_RCMMD,MO(MAC_FN1),FN2_IN,  KC_LEFT,  KC_DOWN, KC_RGHT),
////////////// 0
...
[MAC_FN1] = LAYOUT_ansi_68(
     ...
     _______,  _______,  _______,  _______,  _______,  CGOOGLE,  _______,  CJUS,     _______,  _______,  RALT(KC_N), KC_GRV,             KC_PSCR,  KC_VOLU,
     _______,  _______,  _______,  KC_TILD,  _______,  BAT_LVL,  _______,  KC_MUTE,  _______,  _______,  _______,    _______,  KC_WSCH,            KC_VOLD,
